...
entity hestonEuro_simulation_mt_rng_mt_e_RAM_1WNR_AUTO_1R1W is 
    generic(
        MEM_TYPE        : string    := "auto"; 
        DataWidth       : integer   := 32; 
        AddressWidth    : integer   := 9;
        AddressRange    : integer   := 312
    ); 
    port (
...
architecture rtl of hestonEuro_simulation_mt_rng_mt_e_RAM_1WNR_AUTO_1R1W is 
